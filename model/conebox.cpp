#include "conebox.h"
//Costruttore
ConeBox::ConeBox(const std::string& nome,const std::string &id, u_int c, u_int w, double p, u_int dis, u_int s, u_int h, u_int d): HeightProviderBox(nome, id, c, w, p, dis, s, h), ext_diameter(d) {}

//Costruttore di copia
ConeBox::ConeBox(const ConeBox& c): HeightProviderBox(c.getName(),c.getID(), c.getCapacity(), c.getWeight(), c.getPrice(), c.getDiscount(), c.getStockAvailability(), c.getHeight()), ext_diameter(c.getExtDiameter()) {}
